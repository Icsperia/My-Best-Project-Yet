...
class MQTTEsp32:
        ...
        def identificationInfo(self,CLIENT_ID, MQTT_SERVER, MQTT_PORT,MQTT_USERNAME, MQTT_PASSWORD):
                self.client = MQTTClient(CLIENT_ID, MQTT_SERVER, MQTT_PORT, MQTT_USERNAME, MQTT_PASSWORD)
...
#         def identificationInfo(self,CLIENT_ID, MQTT_SERVER, MQTT_PORT,MQTT_USERNAME, MQTT_PASSWORD, ssl = True):
#                 self.client = MQTTClient(CLIENT_ID, MQTT_SERVER, MQTT_PORT, MQTT_USERNAME, MQTT_PASSWORD, ssl = True)
