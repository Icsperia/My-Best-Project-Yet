...
\begin{itemize}
	...
	\item Abonații reprezintă destinatarul mesajului. Aceștia trebuie să se înregistreze sau să se aboneze la un topicul care îi interesează. Pot să performenze diferite funcții sau să facă ceva diferit cu mesajul în paralel \cite{ps}
