...
\begin{figure}[h]
	\centerline{\includegraphics[width=0.7\textwidth]{Quest3S.png}}
	\caption[(Quest3S)]{Ochelari de realitate virutală Oculus Quest3S}
	\label{fig:top}
\end{figure}
% \nocite{*}
\ToDo {Specificatii robot}
